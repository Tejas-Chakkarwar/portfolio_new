        ...
        <div className="hero">
          ...
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <button className="btn btn-play" onClick={() => window.open('https://drive.google.com/file/d/1FsV6YQFNSusiWHxgacb9udAun88fz5N2/view?usp=drive_link', '_blank')}>▶ Resume</button>
